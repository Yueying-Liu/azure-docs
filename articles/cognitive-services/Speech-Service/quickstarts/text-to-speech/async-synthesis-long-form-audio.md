...
The next step is to prepare an input text file. It can be either plain text or SSML text. For a list of input file requirements, see how to [prepare content for synthesis](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/long-audio-api#prepare-content-for-synthesis).
...
The result contains the input text and the audio output files generated by the service. These are downloaded as a zip.
